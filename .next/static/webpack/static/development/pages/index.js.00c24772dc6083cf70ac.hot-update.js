...
function SelectTime(props) {
  return __jsx("div", null, __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "starts"), ":"), __jsx("div", null), __jsx("input", {
    id: "selectHour",
    type: "number",
    min: 0,
    max: 23
...
//# sourceMappingURL=index.js.00c24772dc6083cf70ac.hot-update.js.map