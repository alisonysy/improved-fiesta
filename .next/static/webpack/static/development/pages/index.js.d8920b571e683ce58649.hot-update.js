    ...
    value: function handleAddedHtml(userInp) {
      ...
      tagWhArr.map(function (item, idx) {
        var result,
            ...
            propExp = /([-\w]+)="(.*)"/g,
            tagExp = /(\w+)[\s]+/;
        console.log('this tag', item.match(tagExp)); // if item.match(tagExp) is null, then tag is item, otherwise, tag is item.match(tagExp)
...
//# sourceMappingURL=index.js.d8920b571e683ce58649.hot-update.js.map