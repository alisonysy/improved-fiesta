...
function SelectTime(props) {
  return __jsx("div", null, __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "starts"), ":"), __jsx("div", null, __jsx("span", null, "Hours:"), __jsx("input", {
    ...
    min: 0,
    max: 23
  }), __jsx("span", null, "Minute:")), __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "ends"), ":"), __jsx("input", {
    id: "selectHour",
    type: "number",
    min: 0,
    max: 59
...
//# sourceMappingURL=index.js.817a0b2ab59e429e3b8d.hot-update.js.map