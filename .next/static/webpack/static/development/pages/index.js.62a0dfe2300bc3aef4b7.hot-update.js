          ...
          if (el.children[0].tagName === 'UL') {
            (function () {
              ...
              ul.addEventListener('animationend', function () {
                ...
                console.log(firstLi);
                var clonedFirstLi = firstLi.cloneNode(false);
                console.log(clonedFirstLi);
                ul.insertAdjacentElement('beforeend', clonedFirstLi);
                ul.removeChild(); // ul.insertAdjacentElement('beforeend',oriFirstChild);
                // ul.removeChild
...
//# sourceMappingURL=index.js.62a0dfe2300bc3aef4b7.hot-update.js.map