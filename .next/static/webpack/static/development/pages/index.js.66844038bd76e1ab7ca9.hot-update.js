      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            ul.addEventListener('animationend', function () {}); // ul.style.transform=`translateY(-${ul.clientHeight / 2}px)`;
          }
        }
      }
    }
...
//# sourceMappingURL=index.js.66844038bd76e1ab7ca9.hot-update.js.map