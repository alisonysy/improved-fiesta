...
function SelectTime(props) {
  return __jsx("div", null, __jsx("div", null, "Please enter the hour(from 0 to 23) and       ", __jsx("input", {
    id: "selectHour",
    type: "number",
    maxLength: 2
  }), "minute(from 0 to 59) that the display ", __jsx("strong", null, "starts"), ":"), __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "ends"), ":"), __jsx("input", {
    id: "selectHour",
    type: "number",
    maxLength: 2
  }));
...
//# sourceMappingURL=index.js.05cdf47e6345647809bc.hot-update.js.map