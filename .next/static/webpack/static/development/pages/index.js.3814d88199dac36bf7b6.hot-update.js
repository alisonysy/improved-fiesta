...
/* harmony import */ var _snippets_imageDropZone__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../snippets/imageDropZone */ "./snippets/imageDropZone.js");
/* harmony import */ var _css_fonts_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../css/fonts.css */ "./css/fonts.css");
/* harmony import */ var _css_fonts_css__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_css_fonts_css__WEBPACK_IMPORTED_MODULE_11__);
...
function BackgroundSetting(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(rgbToHex(props.colorConfig.bgColor)),
      bgColor = _useState[0],
      setBgColor = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])('100'),
      bgOpacity = _useState2[0],
      setBgOpacity = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(rgbToHex(props.colorConfig.txtColor)),
      txtColor = _useState3[0],
      setTxtColor = _useState3[1];

  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])('#fff'),
      specialColor = _useState4[0],
      setSpecialColor = _useState4[1];

  console.log('inside bgSettings', props.colorConfig.bgColor);
  console.log(bgColor);
  Object(react__WEBPACK_IMPORTED_MODULE_8__["useEffect"])(function () {
    props.handleStyleConfig({
      bgColor: rgbToHex(props.colorConfig.bgColor),
      bgOpacity: bgOpacity,
      txtColor: rgbToHex(props.colorConfig.txtColor),
      specialColor: specialColor
    }, undefined);
  }, [bgColor, bgOpacity, txtColor, specialColor]);
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Card"].Section, null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Stack"], null, __jsx("div", null, __jsx("h3", null, "Background color:", bgColor), __jsx("div", {
    style: {
      height: '25px',
      width: '25px',
      borderWidth: '1px',
  ...
  }, bgOpacity), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["TextField"], {
    value: bgOpacity,
    onChange: function onChange(nw) {
  ...
  }))), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Stack"], null, __jsx("div", null, __jsx("h3", null, "Text color:", txtColor), __jsx("div", {
    style: {
      height: '25px',
      width: '25px',
      borderWidth: '1px',
...
function Fonts(props) {
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(18),
      fontSize = _useState5[0],
      setFontSize = _useState5[1];

  var _useState6 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(10),
      padding = _useState6[0],
      setPadding = _useState6[1];

  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])('sans-serif'),
      fontFam = _useState7[0],
      setFontFam = _useState7[1];

  var handleFontFam = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (val) {
    setFontFam(val);
    props.handleStyleConfig(undefined, {
      fontFamily: val
    });
  }, [fontFam]);
  var handleFontSize = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (val) {
    setFontSize(val);
    props.handleStyleConfig(undefined, {
      fontSize: val
    });
  }, []);
  var handlePadding = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (val) {
    setPadding(val);
    props.handleStyleConfig(undefined, {
      barPadding: val
    });
  }, []);
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Card"].Section, null, __jsx("div", null, "Font family:"), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Button"], {
    onClick: function onClick() {
      return handleFontFam('Montserrat');
    }
  }, "Montserrat"), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Button"], {
    onClick: function onClick() {
      return handleFontFam('sans-serif');
    }
  }, "Sans serif"), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["TextField"], {
    label: "Font size:",
    suffix: "px",
    type: "number",
    value: fontSize,
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(StyleConfigPage, [{
    ...
    value: function render() {
      ...
      return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Card"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Form"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["FormLayout"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["DisplayText"], null, "Style Configuration"), __jsx(BackgroundSetting, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
        handleStyleConfig: this.handleStyleConfig
      }, this.props.styleConfig)), __jsx(_snippets_imageDropZone__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
//# sourceMappingURL=index.js.3814d88199dac36bf7b6.hot-update.js.map