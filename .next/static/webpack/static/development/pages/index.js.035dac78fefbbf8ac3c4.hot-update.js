      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            var animKeyframe = "\n            @keyframes infiniteSlide{\n                from {\n                  transform: translateY(0)\n                }\n                to {\n                  transform: translateY(-50%)\n                }\n            }\n          ";
            var animKeyFrame = react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement('style', {}, animKeyframe);
            var keyframeEl = document.createElement('style');
            keyframeEl.textContent = "\n            @keyframes infiniteSlide{\n                from {\n                  transform: translateY(0)\n                }\n                to {\n                  transform: translateY(-50%)\n                }\n            }\n          ";
            console.log(keyframeEl);
            ul.insertAdjacentElement('afterbegin', keyframeEl);
            ul.setAttribute("style", "padding:0;margin:0;list-style:none;transition:all 2.5s;animation:infiniteSlide 2.5s infinite alternate"); // ul.style.transform=`translateY(-${ul.clientHeight / 2}px)`;
          }
        }
      }
    }
...
//# sourceMappingURL=index.js.035dac78fefbbf8ac3c4.hot-update.js.map