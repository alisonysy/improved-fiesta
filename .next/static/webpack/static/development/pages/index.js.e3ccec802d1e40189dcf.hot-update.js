  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SelectCountries, [{
    ...
    value: function handleSelectEvt(el) {
      ...
      el.addEventListener('change', function (evt) {
        ...
        if (clearAll) {
          selectedOpts = [];
          console.log('the arr empty?', selectedOpts);
        }
    ...
    value: function handleClearAllSelected(el) {
      ...
      if (ch.length > 0) {
        ...
        del.setAttribute('style', "cursor:pointer;border:1px solid black;border-radius:5px;margin-left:3em;");
        el.appendChild(del);
...
//# sourceMappingURL=index.js.e3ccec802d1e40189dcf.hot-update.js.map