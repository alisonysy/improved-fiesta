      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            var animKeyframe = "\n            @keyframes infiniteSlide{\n                from {\n                  transform: translateY(0)\n                }\n                to {\n                  transform: translateY(-50%)\n                }\n            }\n          ";
            var animKeyFrame = react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement('style', {}, anim);
            ul.appendChild();
...
//# sourceMappingURL=index.js.cdf44d08ccacee249b6f.hot-update.js.map