            ...
            if (propStr.length) {
              propStr = propStr.map(function (i) {
                var prop_name,
                    prop_val,
                    reg = /.+/;
                console.log('this css style is ', i); //handle carriage return

                if (!i.match(reg)) return;
                i = i.match(reg)[0];
                console.log(i.match(reg), i); //handle extra {
...
//# sourceMappingURL=index.js.dcae96a8b99f1be04ceb.hot-update.js.map