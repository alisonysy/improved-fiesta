...
function ColorPickers(props) {
  ...
  return __jsx("div", null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_10__["ColorPicker"], {
    onChange: setColor,
    color: color
  }));
}
...
function BackgroundSetting(props) {
  ...
  var handleColorChange = function handleColorChange(colorObj) {
    var cl = hslToRgb(colorObj.hue, colorObj.saturation, colorObj.brightness);
    debugger;
...
//# sourceMappingURL=index.js.1c679d996a374436c034.hot-update.js.map