            ...
            if (propStr.length) {
              propStr = propStr.map(function (i) {
                var prop_name,
                    prop_val,
                    reg = /.+/;
                if (!i.match(reg)) return; //handle extra {
                ...
                if (!re_notUrl) return;
                console.log(i, i[0].match(reg));

                if (i[0].match(reg)) {
                  prop_name = i[0].match(reg)[0];
                } else {
                  prop_name = i[0];
                }
...
//# sourceMappingURL=index.js.0b115a794bcbb8f020c4.hot-update.js.map