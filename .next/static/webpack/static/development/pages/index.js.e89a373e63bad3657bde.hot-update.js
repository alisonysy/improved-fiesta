    ...
    value: function handleAddedHtml(userInp) {
      ...
      tagWhArr.map(function (item, idx) {
        var result,
            ...
            propExp = /([-\w]+)="(.*)"/g,
            tagExp = /(\w+)[\s]+/;
        console.log('this tag', item.match(tagExp)); // if item.match(tagExp) is null, then tag is item, otherwise, tag is 
...
//# sourceMappingURL=index.js.e89a373e63bad3657bde.hot-update.js.map