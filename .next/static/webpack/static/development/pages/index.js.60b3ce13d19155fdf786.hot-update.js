      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            keyframeEl.textContent = console.log(animKeyFrame); // ul.insertAdjacentElement('afterbegin',animKeyFrame);
...
//# sourceMappingURL=index.js.60b3ce13d19155fdf786.hot-update.js.map