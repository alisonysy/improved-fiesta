  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(PreviewBar, [{
    ...
    value: function componentDidMount() {
      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        console.log(injectedHtmlElCollection[n].classList.contains('link-container'));
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName.toLowercase === 'a') {
            console.log(el.children[0], 'is a tag');
          }
        }
      }
    }
...
//# sourceMappingURL=index.js.18e01844e40370067685.hot-update.js.map