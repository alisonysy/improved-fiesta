...
function BackgroundSetting(props) {
  var rgbToHex = function rgbToHex(rgb) {
    ...
    var re = rgb.match('match rgb', regExp);
    console.log(re);
  };

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(props.colorConfig.bgColor),
      bgColor = _useState[0],
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(props.colorConfig.txtColor),
  ...
  rgbToHex(props.colorConfig.bgColor);
  ...
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Card"].Section, null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_9__["Stack"], null, __jsx("div", null, __jsx("h3", null, "Background color:"), __jsx("div", {
    style: {
      height: '25px',
      width: '25px',
      borderWidth: '1px',
...
//# sourceMappingURL=index.js.e6de1d6d05f73fd6eb04.hot-update.js.map