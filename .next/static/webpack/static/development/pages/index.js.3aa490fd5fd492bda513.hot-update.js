  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SelectCountries, [{
    ...
    value: function handleSelectEvt(el) {
      ...
      el.addEventListener('change', function (evt) {
        ...
        ;
        clearAll = self.handleClearAllSelected(sp);
        if (clearAll) self.props.handleSelectedTargets(selectedOpts);
      });
    }
  }, {
    ...
    value: function handleClearAllSelected(el) {
      ...
      if (ch.length > 0) {
        ...
        del.setAttribute('style', "cursor:pointer;border:1px solid black;border-radius:5px;");
        el.appendChild(del);
...
//# sourceMappingURL=index.js.3aa490fd5fd492bda513.hot-update.js.map