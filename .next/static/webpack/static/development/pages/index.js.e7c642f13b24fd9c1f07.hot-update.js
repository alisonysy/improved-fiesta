...
function Schedule(props) {
  ...
  var handleTimeSelection = function handleTimeSelection() {
    ...
    startH.addEventListener('input', function (e) {
      ...
      num > 23 ? startT.startH = 23 : num < 0 ? startT.startH = 0 : startT.startH = num;
    });
    startM.addEventListener('input', function (e) {
      var num = e.target.valueAsNumber;
      num > 23 ? startT.startM = 23 : num < 0 ? startT.startM = 0 : startT.startM = num;
    });
    endH.addEventListener('input', function (e) {
      var num = e.target.valueAsNumber;
      num > 23 ? endT.startM = 23 : num < 0 ? startT.startM = 0 : startT.startM = num;
    });
  };
...
//# sourceMappingURL=index.js.e7c642f13b24fd9c1f07.hot-update.js.map