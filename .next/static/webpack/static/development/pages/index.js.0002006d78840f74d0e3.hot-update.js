...
function ColorPickers(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])({
    ...
    saturation: 1
      ...
      color = _useState[0],
      setColor = _useState[1]; // let clFrmProp = props.thisColor;


  Object(react__WEBPACK_IMPORTED_MODULE_9__["useEffect"])(function () {// let h = hexToHsl(clFrmProp).hue, s=hexToHsl(clFrmProp).saturation, l=hexToHsl(clFrmProp).brightness;
    // debugger;
    // console.log(h.toFixed(3),' ',s.toFixed(3),' ',l.toFixed(3));
    // console.log(color.hue.toFixed(3),' ',color.saturation.toFixed(3),' ',color.brightness.toFixed(3));
    // if((h!==undefined && h.toFixed(3)!==color.hue.toFixed(3)) || (s!==undefined && s.toFixed(3)!==color.saturation.toFixed(3)) || (l!==undefined && l.toFixed(3)!==color.brightness.toFixed(3))){
    //   props.handleColorChange(color);
    //   debugger;
    // }
  }, [color]);
  Object(react__WEBPACK_IMPORTED_MODULE_9__["useEffect"])(function () {// setColor(hexToHsl(clFrmProp));
    // debugger;
  }, [clFrmProp]);
  return __jsx("div", {
    style: {
...
function BackgroundSetting(props) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])('#000'),
      bgColor = _useState3[0],
      setBgColor = _useState3[1];

  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])('100'),
      bgOpacity = _useState4[0],
      setBgOpacity = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])('#b31219'),
      txtColor = _useState5[0],
      setTxtColor = _useState5[1];

  var _useState6 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])('#fff'),
      specialColor = _useState6[0],
      setSpecialColor = _useState6[1];
  ...
  var handleColorChange = function handleColorChange(colorObj) {// let cl = hslToRgb(colorObj.hue,colorObj.saturation,colorObj.brightness);
    // debugger;
    // setBgColor(rgbToHex(cl));
    // debugger;
  };

  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_10__["Card"].Section, null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_10__["Stack"], null, __jsx("div", null, __jsx("h3", null, "Background color:"), __jsx("div", {
    style: {
      height: '25px',
      width: '25px',
      borderWidth: '1px',
  ...
  }))), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_10__["Stack"], null, __jsx("div", null, __jsx("h3", null, "Text color:"), __jsx("div", {
    style: {
      height: '25px',
      width: '25px',
      borderWidth: '1px',
...
function Fonts(props) {
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])(18),
      fontSize = _useState7[0],
      setFontSize = _useState7[1];

  var _useState8 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])(10),
      padding = _useState8[0],
      setPadding = _useState8[1];

  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])('sans-serif'),
      fontFam = _useState9[0],
      setFontFam = _useState9[1];
...
//# sourceMappingURL=index.js.0002006d78840f74d0e3.hot-update.js.map