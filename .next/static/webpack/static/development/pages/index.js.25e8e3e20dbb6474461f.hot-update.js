      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            ul.setAttribute("style", "padding:0;margin:0;list-style:none;transition:all 2.5s;animation:infiniteSlide 2.5s infinite running");
...
//# sourceMappingURL=index.js.25e8e3e20dbb6474461f.hot-update.js.map