      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            ul.setAttribute("style", "padding:0;margin:0;list-style:none;transition:all 2.5s;animation:infiniteSlide 2.5s;"); // ul.style.transform=`translateY(-${ul.clientHeight / 2}px)`;
          }
        }
      }
    }
...
//# sourceMappingURL=index.js.b1f3f5ee9fa31f8c77ec.hot-update.js.map