...
function (_React$Component) {
  ...
  function PreviewBar(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "requestAnimation", void 0);
      ...
      for (var n = 0; n < injectedHtmlElCollection.length; n++) {
        ...
        if (el.classList.contains('link-container')) {
          ...
          if (el.children[0].tagName === 'UL') {
            ...
            ul.style.marginTop = "-".concat(ul.clientHeight / 2, "px");
          }
        }
      }
    }
...
//# sourceMappingURL=index.js.1cd6ba4d6e8aae70192d.hot-update.js.map