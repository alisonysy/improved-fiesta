...
function SelectTime(props) {
  return __jsx("div", null, __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "starts"), ":"), __jsx("div", null, __jsx("span", null, "Hour:"), __jsx("input", {
    id: "start_hour",
    type: "number",
    min: 0,
    max: 23
  }), __jsx("span", null, "Minute:"), __jsx("input", {
    id: "selectHour",
    type: "number",
    min: 0,
    max: 59
  })), __jsx("div", null, "Please enter the hour(from 0 to 23) and minute(from 0 to 59) that the display ", __jsx("strong", null, "ends"), ":"), __jsx("div", null, __jsx("span", null, "Hour:"), __jsx("input", {
    id: "end_hour",
    type: "number",
    min: 0,
    max: 23
...
//# sourceMappingURL=index.js.ef0ea8112b19e72dde4a.hot-update.js.map